...
const NavigationBar: FunctionComponent = (): ReactElement => {
    ...
    const routes: IRoute[] = [
        { path: '/', label: 'Book Appointment', icon: <CalendarDaysIcon className='h-4 w-4 text-neutral-content'/> },
        { path: '/bookings', label: 'Bookings', icon: <UserCircleIcon className='h-4 w-4 text-neutral-content'/>},
    ];
